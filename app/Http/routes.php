...
//Route::group(["namespace" => "Iot", "prefix" => "iot" ], function() {
    ...
    Route::get('manage/gatherGap', 'manageController@gatherGap');
    Route::get('manage/sendEmailTime', 'manageController@sendEmailTime');
...
// 储存和返回配置信息是无用户的
Route::get('iot/manage/edisonData', 'Iot\manageController@edisonData');
